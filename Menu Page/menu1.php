...
// Sample array of coffee products (you can remove this once you fetch from DB)
$products = [];
// Fetch products from the database for Coffee category
$query = "SELECT * FROM products WHERE category_id = 1"; // Coffee category_id = 1
  ...
  <header> 
            ...
            <div id="menubar">
                <nav class="menu">
                    ...
                    <ul>
                        ...
                        <li><a href="menu1.php" class="active">Coffee</a></li>
                        <li><a href="menu2.php">Chocolate</a></li>
    ...
    <div class="productRow">
        ...
        foreach ($products as $product) {
            ...
            // Place the image tag here to display the product image
