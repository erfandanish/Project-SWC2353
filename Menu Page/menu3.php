...
// Sample array of smoothie products (you can remove this once you fetch from DB)
$products = [];
            ...
            <div id="menubar">
                <nav class="menu">
                    ...
                    <ul>
                        ...
                        <li><a href="menu3.php" class="active">Smoothie</a></li>
                    </ul>
                </nav>
            </div>
      </section>
        ...
        <section class="mainContent">
            <div class="productRow">
                ...
                foreach ($products as $product) {
                    ...
                    // Add to cart form
                    echo '<form action="menu3.php" method="POST">';
